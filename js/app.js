...
__webpack_require__.r(__webpack_exports__);
let text = document.querySelectorAll('.intro__main-title span');
let i = 1;
...
if (document.querySelector('.guests__carousel')) {
  const guestsCarousel = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.guests__carousel', {
    // Optional parameters
    ...
    navigation: {
      nextEl: '.guests__carousel-next-btn',
      prevEl: '.guests__carousel-prev-btn',
    },
...
if (document.querySelector('.stock__carousel')) {
  const guestsCarousel = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.stock__carousel', {
    // Optional parameters
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination],
    // loop: true,
    slidesPerView: 2,
    ...
    navigation: {
      nextEl: '.stock__carousel-next-btn',
      prevEl: '.stock__carousel-prev-btn',
    },
...
if (document.querySelector('.video__carousel')) {
  const guestsCarousel = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.video__carousel', {
    // Optional parameters
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination],
    // loop: true,
    slidesPerView: 4,
    ...
    navigation: {
      nextEl: '.video__carousel-next-btn',
      prevEl: '.video__carousel-prev-btn',
    },
...
if (document.querySelector('.catalog__carousel')) {
  const guestsCarousel = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.catalog__carousel', {
    // Optional parameters
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination],
    // loop: true,
    slidesPerView: 5,
    ...
    navigation: {
      nextEl: '.catalog__carousel-next-btn',
      prevEl: '.catalog__carousel-prev-btn',
...
document.querySelectorAll('.dropdown').forEach((select) => {
  ...
  dropDownItem.forEach((item) => {
    item.addEventListener('click', (e) => {
      ...
      e.stopPropagation();
      dropDownCurrent.innerText = item.innerText;
...
let intro_content_mobile = document.querySelector('.intro__content-mobile-wrapper');


if (window.innerWidth < 768) {
	intro_content_mobile.appendChild(intro_content);
...
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_mask_phone_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _components_textChanger_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
